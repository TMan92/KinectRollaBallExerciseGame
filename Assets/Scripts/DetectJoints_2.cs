...
public class DetectJoints_2 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        foreach (var body in bodies)
        {
            ...
            if (body.IsTracked)
            {
                ...
                var playerObject = GameObject.Find("Player Scene Two");
    ...
    void SetCountText()
    {
        bodyManager.countText.text = "Collected " + bodyManager.count.ToString();
        if (bodyManager.count >= 14)
        {
            bodyManager.winText.text = "Great Work!";
